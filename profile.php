<?php
	...
	session_start();
$query=mysqli_query($con,"SELECT * FROM customer order by id")or die(mysqli_error());
...
<body>
    ...
    <div class="container-fluid page-header d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5 mb-5">
        <h1 class="display-4 text-white mb-3 mt-0 mt-lg-5">Profile</h1>
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="#" method="post">
					<input class="text" type="text" name="Full_Name" value="<?php echo $row['Full_Name']; ?>"><br>
					<label><p>Date of Birth</p></label>
					<input class="text" type="date" name="DOB" value="<?php echo $row['DOB']; ?>"><br>
					<input class="text" type="text" name="Username" value="<?php echo $row['Username']; ?>">
					<input class="text email" type="email" name="email" value="<?php echo $row['email']; ?>">
