...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="signup.php" class="nav-item nav-link">Wanted</a>
    ...
    <div class="container-fluid page-header d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5 mb-5">
        <h1 class="display-4 text-white mb-3 mt-0 mt-lg-5">Sign Up</h1>
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="#" method="post">
					<input class="text" type="text" name="Full_Name" placeholder="Full Name" required=""><br>
					<label><p>Date of Birth</p></label>
					<input class="text" type="date" name="DOB" placeholder="DoB" required=""><br>
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white mb-2" href="signup.php"><i class="fa fa-angle-right text-primary mr-2"></i>Wanted</a>
