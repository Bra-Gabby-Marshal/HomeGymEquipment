...
textarea, input.email, input.text.w3lpass {
  margin: 2em 0;
}
...
<body>
    ...
    <div class="container-fluid page-header d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5 mb-5">
        <h1 class="display-4 text-white mb-3 mt-0 mt-lg-5">Contact Us</h1>
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="#" method="post">
					<input class="text" type="text" name="y_name" placeholder="name" required="">
					<input class="text email" type="email" name="y_email" placeholder="email" required="">
					<textarea class="text" type="text" name="y_message" placeholder="message" required=""></textarea>
					<div class="wthree-text">
						<div class="clear"> </div>
					</div><br>
				   <p><a href="https://www.termsfeed.com/blog/sample-privacy-policy-template/">click to read our privacy policy</a></p>
