...
<body>
    ...
    <div class="container-fluid page-header d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5 mb-5">
        <h1 class="display-4 text-white mb-3 mt-0 mt-lg-5">Change Password</h1>
        <div class="d-inline-flex text-white">
            <p class="m-0"><a class="text-white" href="">Home</a></p>
            <p class="m-0 px-2">/</p>
            <p class="m-0">changepassword</p>
        </div>
    </div>
    <!-- Page Header Start -->
	...
	<div class="main-w3layouts wrapper">
			...
			<div class="agileits-top">
					...
					<input class="text" type="password" name="currentPassword" placeholder="Current Password" required="">
					<input class="text" type="password" name="newPassword"  placeholder="New Password" required="">
	...
	if(isset($_POST['submit']))
	{
		...
		$sql = "SELECT * FROM customer WHERE id=1 AND password='$current_password'";
